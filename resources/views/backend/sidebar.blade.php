<nav id="sidebar" class="sidebar-wrapper">
    ...
    <div class="sidebar-profile">
        <img src="assets/images/user3.png" class="mb-3 profile-user" alt="Admin Dashboard" />
        <div class="text-center">
            <h6 class="m-0 profile-name text-nowrap text-truncate">
                Floyd Howard
            </h6>
        </div>
        <div class="gap-2 d-flex align-items-center mt-lg-3">
